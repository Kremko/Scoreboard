...
Citizen.CreateThread(function()
	...
	SendNUIMessage({
		...
		uptime = 'https://discord.gg/XsTvDYPs',
		playTime = '00h 00m'
	})
end)
...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, taxi, mechanic, players = ('X'), ('X'), ('X'), ('X'), 0
	...
	for k,v in pairs(connectedPlayers) do
		...
		if v.job == 'ambulance' then
			ems = "<span style='color: #00ff2a;'>✓</span>"
		elseif v.job == 'police' then
			police = "<span style='color: #00ff2a;'>✓</span>"
		elseif v.job == 'taxi' then
			taxi = "<span style='color: #00ff2a;'>✓</span>"
		elseif v.job == 'mechanic' then
			mechanic = "<span style='color: #00ff2a;'>✓</span>"
		end
	end
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, taxi = taxi, mechanic = mechanic, player_count = players}
	})
end
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(57, Keys['F10']) and IsInputDisabled(0) then
			ToggleScoreBoard()
			Citizen.Wait(200)
		end
	end
